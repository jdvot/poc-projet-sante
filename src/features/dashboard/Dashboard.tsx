...
const BiomarkerItem: React.FC<BiomarkerItemProps> = ({ biomarker }) => {
  ...
  return (
    <div role="listitem" style={biomarkerItemStyles.container}>
...
const DashboardStats: React.FC<{ statistics: any }> = ({ statistics }) => (
  <Card withBorder p="md" mb="md">
    ...
    <Progress value={statistics.healthScore} color="green" size="sm" mt="sm" />
  ...
  if (error) {
    return (
      <Container size="lg" py="xl">
        <Stack gap="xl">
          <Title order={1} id="dashboard-title">
            📊 Dashboard Santé
          </Title>
          ...
          >
            <Text size="sm" mb="md">
              Impossible de charger les données du dashboard. Veuillez
              réessayer.
            </Text>
            <Button
      ...
      <Stack gap="xl">
        ...
        {isLoading ? (
          ...
          <>
            ...
            >
              <Stack gap="md">
                <Title order={2} size="h3" id="biomarkers-title">
                  Biomarkers
                </Title>
