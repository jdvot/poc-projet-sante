export const dashboardTranslations = {
  en: {
    dashboard: {
      ...
      noDataDescription: 'No health data has been recorded yet.',
      connectionError: 'Connection Error',
      connectionErrorDescription:
        'Unable to connect to the health data service.',
      ...
      info: {
        ...
        dataSourceDescription: 'Data from your latest health check',
        trendDescription: 'Trend over the last 30 days',
  ...
  fr: {
    dashboard: {
      ...
      info: {
        ...
        dataSourceDescription: 'Données de votre dernier contrôle de santé',
        trendDescription: 'Tendance sur les 30 derniers jours',
      ...
      alerts: {
        ...
        improvement: 'Amélioration significative',
